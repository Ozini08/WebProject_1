...
<!--[if lt IE 9]>
	...
	<script>
		...
		// $(function () {
		// 	$("#save").click(function (event) { // 버튼 클릭 이벤트 핸들러
		// 		event.preventDefault(); // 폼 제출 방지
		//
		// 		var idValue = $("#inputid").val(); // 입력된 아이디 값 가져오기
		// 		var passwordValue = $("#inputPassword").val(); // 입력된 비밀번호 값 가져오기
	...
	<div class="container" style="margin-top: 120px">
		<div class="row">
			<div class="main">
				...
				<form action="${pageContext.request.contextPath}/SignUp.do?cmd=SignUp" method="post">
					...
					<div class="form-group">
						<input type="text" placeholder="비밀번호" class="form-control"
							id="inputpass" name="pass"/>

					</div>
					<div class="form-group">
						<!--<a class="pull-right" href="#">Esqueci a senha</a>-->
						<input type="password" placeholder="비밀번호 확인" class="form-control"
							id="inputPassword" name="passcheck"/>
					</div>
					<div class="row">
						<div class="col-xs-12 col-sm-12 col-md-12">
							<button href="#" class="btn btn-sm btn-info btn-block" type="submit" id="save">SIGN UP</button>
						</div>
					</div>
