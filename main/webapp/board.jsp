...
<form action="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList" method="post">
    <div class="board-field">
        ...
        <div class="col-md-8">
            <div class="board-toolbar" style="text-align: right; margin-bottom: 20px">
                <table>
                    <td>
                        <select style="width: 150%" id="query" name="query">
                            <option value="empty">선택하세요</option>
                            <option value="category">category</option>
                            <option value="title">TITLE</option>
                            <option value="writer">WRITER</option>
                            <option value="boardcontent">BOARDCONTENT</option>
                        </select>

                    </td>
                    <td>
                        <input type="text" id="data" name="data" class="inputText" size="50"/>
                    </td>
                    <td>
                        <span class="button" id="search"><a href="#" class="btn btn-primary btn-sm">검색</a></span>
                    </td>
                    <br>
                    <td>
                <span><a href="write.jsp" class="btn btn-primary btn-sm"><i
                        class="glyphicon glyphicon-pencil" style="margin-right: 15px"></i>쓰기</a></span></td>
                </table>
            </div>
            ...
            <div class="col-md-8">
                <ul class="pagination">
                    <li><a href="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList&page=1">처음</a></li>
                    <c:choose>
                        <c:when test="${pageBean.currentBlock>1 }">
                            <li>
                                <a href="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList&page=${pageBean.startPage-1}">이전</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="#">이전</a></li>
                    ...
                    <c:forEach var="i" begin="${pageBean.startPage}" end="${pageBean.endPage}">
                        <c:choose>
                            ...
                            <c:otherwise>
                                <li><a href="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList&page=${i}">
                                    [${i}]</a></li>
                            </c:otherwise>
                        </c:choose>
                    ...
                    <c:choose>
                        <c:when test="${pageBean.totalPage > pageBean.endPage }">
                            <li>
                                <a href="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList&page=${pageBean.endPage+1}">다음</a>
                            </li>
                        </c:when>
                        <c:otherwise>
                            <li><a href="#">다음</a></li>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/BoardList.do?cmd=BoardList&page=${pageBean.totalPage}">마지막</a>
                    </li>
                </ul>
            </div>
        </div>
