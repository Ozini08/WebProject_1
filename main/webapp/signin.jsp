        ...
        $(function () {
            $("button#btnSubmit").click(function () {
                    $.ajax({
                        ...
                        type:'POST',
                        data:{"cmd":'SignIn',"id":$("input#user_id").val(),"password":$("input#user_passwd").val()},
                        success:function(data){
                            if(data.trim()=='T'){
                                document.location.href='${pageContext.request.contextPath}/BoardList.do?cmd=BoardList';
                            }else if(data.trim()=='F'){
                                alert("fail");
                            }
                        },error:function(){
...
<div class="container" style="margin-top: 120px">
    <div class="row">
        <div class="main">
            ...
            <form action="${pageContext.request.contextPath}/SignIn.do?cmd=SignIn" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" placeholder="PASSWORD " class="form-control"
                           id="user_passwd" name="password"/>
                </div>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <button id="btnSubmit" class="btn btn-sm btn-danger btn-block" type="submit">SIGN IN</button>
                    </div>
                </div>
                <div class="login-or">
                    <hr class="hr-or">
