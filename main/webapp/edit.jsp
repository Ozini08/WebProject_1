...
<form action="${pageContext.request.contextPath}/BoardUpdate.do?cmd=BoardUpdate&boardno=${info.boardno}" method="post">
    <div id="write-field">
                        ...
                        <div class="row row-xs-bskr">
                            <div class="col-md-6 col-sm-6 col-xs-bskr">
                                ...
                                <div class="input-forms">
                                    <input size="20" type="text" name="writer" value="${info.writer}"
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-bskr">
                                ...
                                <div class="input-forms">
                                    <input size="20" type="password" name="password" value="${info.password}"
                ...
                <table>
                    <tr>
                        ...
                        <td calss="td2"><textarea class="form-control col-sm-5"
                                                  rows="20" name="boardcontent">${info.boardcontent}</textarea></td>
                    </tr>
                    <tr>
                        <td class="td1"></td>
...
<%--                       onclick="return cancelCheck();"/>&nbsp;--%>
                ...
                <button id="submitPost" type="submit" name="save" class="btn btn-primary btn-sm">
